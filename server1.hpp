...
// 数字实现基本功能game_interface1_2_3  同时解决-1和其他数字被对方看到的问题
class GameServer {
public:
    int flag = 0;
    int js = 0;
...
private:
    ...
    void generate_unique_numbers() {
        ...
        if (flag == 0) {    
            ...
            // 后续回合：每个玩家获得一个新数字
            player_numbers_["player1"].insert(dis(gen));
